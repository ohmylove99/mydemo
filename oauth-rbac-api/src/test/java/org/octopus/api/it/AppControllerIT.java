...
public class AppControllerIT {
	...
	@Test
	public void test_findByAllPage() throws Exception {
		// given
		AppEntity entity1 = AppEntity//
				.builder()//
				.name("MyApp")//
	...
	@Test
	public void test_findByAllList() throws Exception {
		// given
		AppEntity entity1 = AppEntity//
				.builder()//
				.name("MyApp")//
	...
	@Test
	public void test_patch_whennotfound_then404() throws Exception {
		// given
		AppEntity entity1 = AppEntity//
				.builder()//
				.name("MyApp")//
	...
	@Test
	public void test_patch_whenunsupportfield_then405() throws Exception {
		// given
		AppEntity entity1 = AppEntity//
				.builder()//
				.name("MyApp")//
	...
	@Test
	public void test_patch_ok() throws Exception {
		// given
		AppEntity entity1 = AppEntity//
				.builder()//
				.name("MyApp")//
