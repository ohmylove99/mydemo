...
public class AppControllerLT {
	...
	@Test
	public void when_api_app_create_then_ok_201() throws JSONException {
		...
		ResponseEntity<String> response = restTemplate.postForEntity(BaseUrl + "/api/app", entity, String.class);
	...
	@Test
	public void when_api_app_create_then_ok_201_with_warninglog() throws JSONException {
		// when with setter id
	...
	@Test
	public void when_api_app_update_then_ok_200() throws JSONException {
		// when with setter id
		...
		ResponseEntity<?> response2 = restTemplate.exchange(BaseUrl + "/api/app/" + id, HttpMethod.PUT, entity2,
				String.class);
		// AppDto.class);
	...
	@Test
	public void when_api_app_patch_then_ok_200() throws JSONException {
		// when with setter id
		...
		ResponseEntity<?> response2 = patchRestTemplate.exchange(BaseUrl + "/api/app/" + id, HttpMethod.PATCH, entity2,
				String.class);
		// AppDto.class);
		...
		ResponseEntity<?> response3 = patchRestTemplate.exchange(BaseUrl + "/api/app/" + id, HttpMethod.PATCH, entity3,
				String.class);
		// AppDto.class);
	...
	@Test
	public void when_api_app_patch_unsupportedfield_then_fail() throws JSONException {
		// when with setter id
		AppDto dto = AppDto.builder().appId("appid").shortName("app1").name("application1").contact("a@gmail.com")
				.build();
		...
		try {
			patchRestTemplate.exchange(BaseUrl + "/api/app/" + id, HttpMethod.PATCH, entity3, String.class);
			fail();
	...
	public void when_delete_accept_202() throws JSONException {
		...
		ResponseEntity<String> response1 = restTemplate.exchange(BaseUrl + "/api/app/" + id, HttpMethod.DELETE, entity1,
				String.class);
	...
	@Test
	public void when_delete_notfound_then_faile_404() throws JSONException {
		// when with setter id
		HttpHeaders headers = new HttpHeaders();
		MediaType type = MediaType.parseMediaType("application/json; charset=UTF-8");
		headers.setContentType(type);
		...
		try {
			restTemplate.exchange(BaseUrl + "/api/app/abc1", HttpMethod.DELETE, entity1, String.class);
			fail();
		} catch (HttpClientErrorException e) {
